    ...
    <div className='card listings-wrapper'>
      <div className='card-body container-fluid listings'>
        <div className='row table-header d-flex align-items-center'>
          <div className='col-lg-4'>Investment Opportunity</div>
          ...
          <div className='col-lg-2 text-center'>Repayment</div>
        ...
        {listings.map((listing, idx) => (
          ...
          >
            ...
            <div className='col-3 proj-name'>{listing.projectTitle}</div>
            ...
            <div className='col-lg-2 text-center'>$865.00</div>

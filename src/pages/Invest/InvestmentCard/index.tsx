          ...
          <div className='row p-0 w-100'>
            ...
            <div className='col-lg-6 d-flex justify-content-end align-items-end'>
              <h4 className='text-white'>
                CASH BALANCE: <span className='text-success'>123456</span>
              </h4>
            </div>
          </div>
          <div className='row'>
            <div className='col-lg-8 d-flex justify-content-start align-items-end'>
              <div className='w-100'>
            ...
            <div className='col-lg-4 d-flex justify-content-end align-items-end'>
              <button className='btn btn-primary text-primary w-100 btn-sm'>
                Submit Your Order
              </button>
            </div>
          </div>
